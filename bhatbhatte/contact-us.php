...
<head>
    ...
    <title>Contact Us - BhatBhatte</title>
...
<body>
    <nav class="navbar navbar-light navbar-expand-lg fixed-top bg-dark clean-navbar" data-aos="fade-down" data-aos-duration="250">
        <div class="container"><a class="text-center" href="Home_page.php" style="color: rgb(243,245,247);width: 20px;height: 30px;padding: -30px;"><br>BHATBHATTE<br><br></a><button data-toggle="collapse" class="navbar-toggler" data-target="#navcol-2"><span class="sr-only">Toggle navigation</span><span class="navbar-toggler-icon"></span></button>
            <div class="collapse navbar-collapse" id="navcol-2">
                <ul class="navbar-nav ml-auto"></ul><a href="Home_page.php" style="margin: 5px;padding: 3px;">HOME</a><a href="login.php" style="margin: 5px;padding: 3px;">Sign In</a><a href="login.php" style="margin: 5px;padding: 3px;">Book Now!!!</a>
            </div>
        </div>
    </nav>
    <main class="page contact-us-page">
        <section class="clean-block clean-form dark">
            <div class="container">
                ...
                <form>
                    <div class="form-group"><label for="name">Full Name</label><input class="form-control" type="text" id="name" name="name"></div>
